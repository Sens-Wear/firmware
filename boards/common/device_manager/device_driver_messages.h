...
struct touch_msg_t {
	...
	uint16_t x;			 /**< Linear strip X, 0..896 (valid when @c touched). */
	uint16_t y;			 /**< Reserved zero on the linear touch strip. */
 ...
 *          event enum; @c gesture_state uses the MTCH6102 byte codes generated by the host.
 */
