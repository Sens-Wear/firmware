...
union bq25180_STAT1_register_t {
    ...
    struct bq25180_STAT1_register_bits {
        unsigned int bWake2Flag: 1;             /**< WAKE2 timer event occurred. */
        unsigned int bWake1Flag: 1;             /**< WAKE1 timer event occurred. */
 ...
 */
#define BQ25180_ICHG_OUT_DEFAULT \
    BQ25180_ICHG_VAL_TO_OUT(BQ25180_ICHG_VAL_DEFAULT)
...
union bq25180_TS_CONTROL_register_t {
    ...
    struct bq25180_TS_CONTROL_register_bits {
        ...
        unsigned int bFastChargeCurrentReductionInThermalSystem: 1; /**< Reduce current in cool/warm regions. */
