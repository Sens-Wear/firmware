...
|------|--------|--------------|
| `main_test_drv2605.c` | DRV2605 haptics (senswear_haptic shield) | check haptics ready → warm the device through the haptics API → configure RTP and ROM sources → exercise an RTP amplitude ramp and a ROM library click in sequence every 2 s |
