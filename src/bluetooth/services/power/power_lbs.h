...
#define BT_UUID_LBS_POWER_DAUGHTER_STATE_VAL BT_UUID_128_ENCODE(0x8f9a1c23, 0x84e7, 0x4a73, 0x9a57, 0x6f6d5d0ab1c2)
...
#define BT_UUID_LBS_POWER_DAUGHTER_STATE BT_UUID_DECLARE_128(BT_UUID_LBS_POWER_DAUGHTER_STATE_VAL)

#define POWER_LBS_DAUGHTER_MASK_PPG BIT(0)
#define POWER_LBS_DAUGHTER_MASK_TEMPERATURE BIT(1)
#define POWER_LBS_DAUGHTER_MASK_TOUCH BIT(2)
#define POWER_LBS_DAUGHTER_MASK_HAPTIC BIT(3)

#define POWER_LBS_DAUGHTER_FLAG_REGULATOR_ENABLED BIT(0)
#define POWER_LBS_DAUGHTER_FLAG_PPG_REQUESTED BIT(1)

enum power_lbs_daughter_board_type {
	POWER_LBS_DAUGHTER_BOARD_NONE = 0,
	POWER_LBS_DAUGHTER_BOARD_PPG = 1,
	POWER_LBS_DAUGHTER_BOARD_TEMPERATURE = 2,
	POWER_LBS_DAUGHTER_BOARD_TOUCH = 3,
	POWER_LBS_DAUGHTER_BOARD_HAPTIC = 4,
};
...
struct power_lbs_daughter_state {
	uint8_t connected_mask;
	uint8_t active_board;
	uint16_t regulator_mv;
	uint8_t flags;
} __packed;
...
struct power_lbs_ops {
	...
	int (*get_daughter_state)(struct power_lbs_daughter_state *state);
};
